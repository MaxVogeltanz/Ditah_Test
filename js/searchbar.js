...
function initializeLunr() {
    ...
    // Attach the Enter key event listener here after initialization
...
// Move the event listener initialization inside initializeLunr to ensure it is attached after Lunr is ready
